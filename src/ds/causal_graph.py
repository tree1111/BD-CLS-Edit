# This file is adapted from the implementation of:
#   Xia, Kevin Muyuan, Yushu Pan, and Elias Bareinboim. "Neural Causal Models for Counterfactual Identification and Estimation." 
#   Original code: https://github.com/CausalAILab/NCMCounterfactuals
